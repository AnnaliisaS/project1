...
function loadStories() {
    ...
    for (var i = 0; i < storyState.length; i++) {
        var url = "https://openlibrary.org/api/books?bibkeys=" + storyState[i] + "&jscmd=details&format=json";
        fetch(url)
